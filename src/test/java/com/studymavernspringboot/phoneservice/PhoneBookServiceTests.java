...
public class PhoneBookServiceTests {
    ...
    public void phoneBookServiceImplTest() throws Exception {
        IPhoneBookService<IPhoneBook> jsonService = new PhoneBookServiceImpl("-j", "KJS.json");
        IPhoneBookService<IPhoneBook> textService = new PhoneBookServiceImpl("-t", "KJS.txt");
